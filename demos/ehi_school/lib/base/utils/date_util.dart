...
class DateFormats {
  static const String YMD_HMS = 'yyyy-MM-dd HH:mm:ss';
  ...
  static const String MD_HM = 'MM-dd HH:mm';
  static const String HMS = 'HH:mm:ss';
  static const String HM = 'HH:mm';

  static const String ZH_YMD_HMS = 'yyyy年MM月dd日 HH时mm分ss秒';
  static const String ZH_YMD_HM = 'yyyy年MM月dd日 HH时mm分';
  static const String ZH_YMD = 'yyyy年MM月dd日';
  static const String ZH_YM = 'yyyy年MM月';
  static const String ZH_MD = 'MM月dd日';
  static const String ZH_MD_HM = 'MM月dd日 HH时mm分';
  static const String ZH_HMS = 'HH时mm分ss秒';
  static const String ZH_HM = 'HH时mm分';
}
...
class DateUtil {
  ...
  static String formatDate(DateTime? dateTime, {String? format}) {
    ...
    format = format ?? DateFormats.YMD_HMS;
